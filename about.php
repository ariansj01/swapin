    ...
    <div class="card mb-6">
      <div class="card-body" style="padding:var(--sp-8)">
        ...
        <p style="color:var(--text-secondary);line-height:1.8;margin-bottom:var(--sp-4)">
          <?= APP_NAME ?> از دو جریان قدرتمند الهام گرفت: تجربه جهانی پلتفرم‌های موفق مبادله کالا با کالا مانند Bunz و حقیقت بزرگی که در بحران‌ها آشکار شد.

وقتی سیستم‌های بانکی سنتی در جریان جنگ روسیه و اوکراین مختل شدند، مردم در پلتفرم‌هایی مثل OLX و شبکه‌های اجتماعی شروع به مبادله مستقیم کالا کردند. در آنجا دیدیم که چطور معاوضه دوباره به روشی قدرتمند و انسانی برای برآوردن نیازها بدون پول نقد تبدیل شد—همان مسیری که پلتفرم‌هایی نظیر Bunz سال‌هاست با موفقیت در سطح جهان دنبال می‌کنند.

ما سواَپین را ساختیم تا به این تبادل طبیعی و مدرن، خانه‌ای اختصاصی و امن بدهیم: بازاری ساختاریافته با تطبیق هوشمند، اقتصاد اعتباری و زیرساخت اعتماد، تا معاوضه به خوبی (یا حتی بهتر از) تجارت نقدی کار کند.
        </p>
