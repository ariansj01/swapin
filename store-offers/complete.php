  ...
  <div class="ex-container">
    ...
    <div class="ex-hero">
      ...
      <p class="ex-hero__subtitle">
        معامله شما در سیستم سواَپین به صورت رسمی ثبت شد.
        <br>
      ...
      <div class="ex-alert ex-alert--info" style="margin-top:28px;text-align:right;max-width:560px;margin-right:auto;margin-left:auto">
        ...
        تیم پشتیبانی سواَپین در تمام مراحل معامله همراه شماست. در صورت بروز هرگونه سوال یا مشکل، از طریق اتاق معامله تیکت پشتیبانی ثبت کنید.
      </div>
    </div>
