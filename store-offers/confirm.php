  ...
  <div class="ex-container">
    ...
    <div class="ex-card">
      ...
      <div class="ex-alert ex-alert--info" style="margin-top:16px;margin-bottom:0">
        ...
        با کلیک روی «تأیید و شروع»، معامله به صورت رسمی ثبت می‌شود و شما وارد محیط امن «اتاق معامله» می‌شوید. از این لحظه به بعد، تمامی مراحل زیر نظر پشتیبانی سواَپین انجام می‌شود.
      </div>
    </div>
