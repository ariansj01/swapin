...
$user = auth_user();
$metaTitle = 'سوالات متداول سواپین | راهنمای کامل معاوضه کالا و پاسخ به پرسش‌های کاربران';
$metaDesc  = 'پاسخ به تمام سوالات شما درباره سواپین، نحوه ثبت‌نام، ثبت کالا، ارسال پیشنهاد معاوضه، ارزش‌گذاری هوشمند، اتاق امن معامله و قوانین پلتفرم.';
...
$faqs = [
    [
        'q' => 'سواپین چیست؟',
        'a' => 'سواپین یک پلتفرم هوشمند برای معاوضه کالا با کالا است که به کاربران کمک می‌کند بدون نیاز به فروش کالا، آن را با کالای موردنیاز خود مبادله کنند. در سواپین علاوه بر معاوضه مستقیم، در صورت وجود اختلاف قیمت، امکان پرداخت یا دریافت مابه‌التفاوت نیز وجود دارد.',
    ],
    [
        'q' => 'چگونه در سواپین ثبت‌نام کنم؟',
    ...
    [
        ...
        'a' => 'بله، ثبت کالا در سواپین رایگان است.<br><br>ممکن است برخی امکانات ویژه یا خدمات تبلیغاتی در آینده به‌صورت اختیاری ارائه شوند.',
    ],
    [
        'q' => 'آیا می‌توانم کالا را فقط بفروشم؟',
        'a' => 'خیر.<br><br>تمرکز اصلی سواپین بر معاوضه کالا است و کاربران برای هر کالا، کالای موردنیاز خود را نیز مشخص می‌کنند.',
    ],
    [
    ...
    [
        ...
        'a' => 'دستیار هوشمند سواپین پیشنهادهای مناسب را بر اساس موارد زیر به شما نمایش می‌دهد:<br><br>• ارزش کالا<br>• نیاز کاربران<br>• دسته‌بندی<br>• احتمال موفقیت معامله',
    ],
    [
    ...
    [
        'q' => 'آیا سواپین امنیت معاملات را تضمین می‌کند؟',
        'a' => 'سواپین تلاش می‌کند با استفاده از ابزارهای امنیتی، احراز هویت کاربران و فرآیندهای نظارتی، محیطی امن برای انجام معاملات فراهم کند. با این حال، کاربران نیز باید اطلاعات کالا و شرایط معامله را با دقت بررسی کرده و مطابق قوانین پلتفرم اقدام کنند.',
    ],
    [
        'q' => 'آیا امکان لغو معامله وجود دارد؟',
        'a' => 'تا پیش از نهایی شدن معامله، امکان انصراف وجود دارد.<br><br>پس از نهایی شدن، شرایط لغو مطابق قوانین سواپین بررسی خواهد شد.',
    ],
    [
    ...
    [
        'q' => 'چگونه با پشتیبانی سواپین تماس بگیرم؟',
        'a' => 'از طریق بخش پشتیبانی داخل سایت می‌توانید سوالات یا درخواست‌های خود را ثبت کنید و پاسخ دریافت نمایید.',
    ],
    [
        'q' => 'آیا استفاده از سواپین روی موبایل امکان‌پذیر است؟',
        'a' => 'بله.<br><br>سواپین روی موبایل، تبلت و رایانه قابل استفاده است و می‌توانید از طریق مرورگر به حساب کاربری خود دسترسی داشته باشید.',
    ],
    [
        'q' => 'هنوز پاسخ سوال خود را پیدا نکرده‌ام',
        'a' => 'اگر پاسخ سوال خود را در این صفحه پیدا نکردید، از طریق بخش پشتیبانی یا دستیار هوشمند سواپین با ما در ارتباط باشید. تیم پشتیبانی در کوتاه‌ترین زمان ممکن شما را راهنمایی خواهد کرد.',
    ],
];
...
<main id="main-content" class="section-sm">
  <div class="container-md">
    ...
    <div style="text-align:center;padding:var(--sp-8) 0 var(--sp-6)">
      ...
      <h1 style="font-size:2.25rem;margin:0 0 var(--sp-3)">سوالات متداول سواپین</h1>
      <p style="font-size:1.125rem;color:var(--text-secondary);max-width:640px;margin:0 auto;line-height:1.8">
        پاسخ تمام پرسش‌های رایج شما درباره معاوضه کالا در سواپین را در این صفحه پیدا کنید.
      </p>
    </div>
    ...
    <div class="card mb-8" style="background:linear-gradient(135deg,rgba(26,107,74,.04),rgba(79,134,247,.06));border:1px solid rgba(79,134,247,.15)">
      <div class="card-body" style="padding:var(--sp-8);text-align:center">
        ...
        <p style="color:var(--text-secondary);line-height:1.9;margin-bottom:var(--sp-6)">
          تیم پشتیبانی سواپین و دستیار هوشمند ما آماده پاسخگویی به شما هستند.
        </p>
