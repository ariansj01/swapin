...
function swapin_content_defaults(): array {
    return [
        ...
        'home_ai_desc'            => 'بعد از ثبت کالا، هوش مصنوعی سواَپین ارزش تقریبی را محاسبه می‌کند. با دستیار AI هم درباره بهترین گزینه‌های معاوضه مشورت کنید.',
        ...
        'footer_copy'             => 'تمامی حقوق این وبسایت متعلق به سواَپین می‌باشد.',
    ];
}
