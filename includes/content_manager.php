...
function swapin_content_defaults(): array {
    return [
        'home_meta_title'         => 'سواپین | بازار هوشمند مبادله کالا',
        'home_meta_desc'          => 'سواپین - بزرگترین پلتفرم هوشمند مبادله کالا با کالا در ایران. کالاهای خود را ثبت کنید و با چیزهایی که نیاز دارید معاوضه کنید.',
        'hero_title_line_1'       => 'سواپین؛ پلتفرم هوشمند',
        ...
        'footer_brand_tagline'    => 'سواپین بستری امن و آسان برای معاوضه تهاتر کالا های نو و دست دوم بین کاربران',
